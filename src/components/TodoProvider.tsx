import React, {useReducer, createContext, useContext, useRef, ReactNode} from 'react';
...
const TodoNextIdContext = createContext<React.MutableRefObject<number> | undefined>(
    undefined
);
